...
![3](./assets/容器化运维/3.gif)

同样的道理，我们来部署一个nginx:

![4](./assets/容器化运维/4.gif)
...
![docker-version](./assets/容器化运维/docker-version.jpg)
...
![devOps](./assets/容器化运维/devOps-8692746.jpeg)
